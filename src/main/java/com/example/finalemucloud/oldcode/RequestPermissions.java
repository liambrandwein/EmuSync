    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonRequest.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ContextCompat.checkSelfPermission(RequestPermissions.this,
                        Manifest.permission.READ_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED) {
                    Toast.makeText(RequestPermissions.this, "You have already granted this permission!",
                            Toast.LENGTH_SHORT).show();
                    Intent homeIntent = new Intent(RequestPermissions.this, MainActivity2.class);
